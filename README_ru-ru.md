...
2. Скачайте последнюю доступную версию(или как вам нужно)

### Использование
1. Убедитесь, что `HoYoKProtect.dll` находится в той же папке, что и `injector.exe`. (не рекомендуется распологать файлы инжектора, в папке с игрой)
...
<!-- Перевод выполнен QweRez-on -->
<!-- Дискорд/Discord qwerezon-->
